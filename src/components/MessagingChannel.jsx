  ...
  return (
    <div className="w-1/6  h-full sm:block hidden  bg-[#faf9f9] text-[14px] text-[#9c9c9c]  border-[1px]">
      <div className="w-full h-5/6">
        <div
          id="select-channel "
          className="w-full h-fit p-4  flex flex-col justify-around"
        >
          <p className="text-[#10a37f] font-[500]">messaging channels</p>
          <div
            id="channelSelect"
            className="text-[14px] border-[0.5px] border-gray-400 w-full flex justify-between items-center text-[#9c9c9c] bg-inherit rounded-lg mt-2"
          >
